 ...
 * Classe Android : FEN_Horodateur1
...
public class GWDFFEN_Horodateur1 extends WDFenetre
{

////////////////////////////////////////////////////////////////////////////
// Déclaration des champs de FEN_Horodateur1
////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°1 de FEN_Horodateur1.SAI_Heure_de_fin
////////////////////////////////////////////////////////////////////////////
...
super.setQuid(2800844041713358897l);

super.setChecksum("679007497");
...
super.setPositionInitiale(41, 277);
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°2 de FEN_Horodateur1.SAI_Heure_de_début
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
...
super.setRectLibelle(0,2,182,40);
super.setRectCompPrincipal(182,2,67,40);
super.setQuid(2800844041713424433l);

super.setChecksum("679073033");
...
super.setPositionInitiale(41, 184);
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°3 de FEN_Horodateur1.LIB_Horodateur
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(2800844041713489969l);

super.setChecksum("678999642");
...
super.setPositionInitiale(41, 30);
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°4 de FEN_Horodateur1.BTN_Valider
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(2800844041713555505l);

super.setChecksum("679065634");
...
super.setPositionInitiale(87, 388);
 ...
 * LIB_Prise_1
 */
class GWDLIB_Prise_1 extends WDLibelle
{

////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°5 de FEN_Horodateur1.LIB_Prise_1
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(2800844041713621041l);

super.setChecksum("679130714");

super.setNom("LIB_Prise_1");
...
super.setLibelle("Prise 1");

super.setNote("");

super.setEtatInitial(0);

super.setPositionInitiale(85, 100);
...
public GWDLIB_Prise_1 mWD_LIB_Prise_1;

/**
 * Traitement: Déclarations globales de FEN_Horodateur1
 */
...
////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////
// Création des champs de la fenêtre FEN_Horodateur1
////////////////////////////////////////////////////////////////////////////
...
mWD_LIB_Prise_1 = new GWDLIB_Prise_1();

}
////////////////////////////////////////////////////////////////////////////
// Initialisation de la fenêtre FEN_Horodateur1
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.setQuid(2800844041713293361l);

super.setChecksum("684201675");

super.setNom("FEN_Horodateur1");
...
////////////////////////////////////////////////////////////////////////////
// Initialisation des champs de FEN_Horodateur1
////////////////////////////////////////////////////////////////////////////
...
mWD_LIB_Prise_1.initialiserObjet();
super.ajouter("LIB_Prise_1", mWD_LIB_Prise_1);
...
{
return GWDPProjetDomotique.ms_Project.mWD_FEN_Horodateur1;
}
}
/**
