 ...
 * Classe Android : FEN_Horodateur2
...
public class GWDFFEN_Horodateur2 extends WDFenetre
{

////////////////////////////////////////////////////////////////////////////
// Déclaration des champs de FEN_Horodateur2
////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°1 de FEN_Horodateur2.BTN_Valider
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(2800844333781427110l);

super.setChecksum("689161179");
...
super.setPositionInitiale(88, 387);
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°2 de FEN_Horodateur2.SAI_Heure_de_fin
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
...
super.setQuid(2800844333781558182l);

super.setChecksum("689430722");
...
super.setPositionInitiale(42, 276);
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°3 de FEN_Horodateur2.SAI_Heure_de_début
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
...
super.setRectLibelle(0,2,182,40);
super.setRectCompPrincipal(182,2,67,40);
super.setQuid(2800844333781689254l);

super.setChecksum("689561794");
...
super.setPositionInitiale(42, 183);
 ...
 * LIB_Prise_2
 */
class GWDLIB_Prise_2 extends WDLibelle
{

////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°4 de FEN_Horodateur2.LIB_Prise_2
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(2800844333781820341l);

super.setChecksum("689553954");

super.setNom("LIB_Prise_2");
...
super.setLibelle("Prise 2");

super.setNote("");

super.setEtatInitial(0);

super.setPositionInitiale(86, 99);
...
public GWDLIB_Prise_2 mWD_LIB_Prise_2;
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°5 de FEN_Horodateur2.LIB_Horodateur
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(2800844333781951413l);

super.setChecksum("689685026");
...
super.setPositionInitiale(42, 29);
...
/**
 * Traitement: Déclarations globales de FEN_Horodateur2
 */
...
////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////
// Création des champs de la fenêtre FEN_Horodateur2
////////////////////////////////////////////////////////////////////////////
...
mWD_LIB_Prise_2 = new GWDLIB_Prise_2();
mWD_LIB_Horodateur = new GWDLIB_Horodateur();

}
////////////////////////////////////////////////////////////////////////////
// Initialisation de la fenêtre FEN_Horodateur2
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.setQuid(2800844247880881854l);

super.setChecksum("693360008");

super.setNom("FEN_Horodateur2");
...
////////////////////////////////////////////////////////////////////////////
// Initialisation des champs de FEN_Horodateur2
////////////////////////////////////////////////////////////////////////////
...
mWD_LIB_Prise_2.initialiserObjet();
super.ajouter("LIB_Prise_2", mWD_LIB_Prise_2);
...
{
return GWDPProjetDomotique.ms_Project.mWD_FEN_Horodateur2;
}
}
/**
